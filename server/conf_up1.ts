...
const _main_profile_source_to_name: Dictionary<string> = {
    ...
    'comptex/heberge' : 'hébergé géré par la DEVE dans <a target=_blank href="https://comptex.univ-paris1.fr/heberge/">Gestion des comptes hébergés</a>',
...
export const raw_explain_main_profile = (v: v) => {
    ...
    let m
    const source = 
        profilename.match(/^\{HARPEGE}heberge/) ? 'comptex/heberge' : 
