...
export default {
    ...
    pattern: {
        ...
        password: // if empty, it will use https://zxcvbn-ts.github.io/zxcvbn/ to display warnings/suggestions about password strength
            "(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])[ -~]{8,}", // must contain digit / uppercase / lowercase. must be printable ASCII chars
    },
    error_msg: {
