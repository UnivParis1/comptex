...
const tests: (Omit<ClientSideSVA, 'stepName'> & { test_name: string })[] = [
    ...
    },
    {
        ...
        attrs: {
            "checkbox": { title: "A checkbox", description: "description", uiType: 'checkbox' },
            "radio": { title: "A radio", oneOf: [ { const: "c1", title: "Choice One" }, { const: "c2", title: "Choice Two" } ] },
            "select": { title: "A radio", oneOf: [ { const: "c1", title: "Choice One" }, { const: "c2", title: "Choice Two" }, { const: "c3", title: "Choice Three" } ] },
...
export default defineComponent({
    ...
    data() {
        return {
            tests,
            ...tests[0],
            v_orig: undefined, v_string: undefined, v_html: undefined, v_err: undefined, v_has_dates: undefined,
    ...
    watch: {
        ...
        v: { deep: true, handler() { this.set_v_string() } },
        attrs: { deep: true, handler() { this.set_attrs_string() } },
    },
    computed: {
    },
    methods: {
